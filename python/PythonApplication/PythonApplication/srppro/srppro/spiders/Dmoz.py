...
from srppro.items import DmozItem
...
class DmozSpider(scrapy.spiders.Spider):
    ...
    # 作为参数调用parse函数
    start_urls = ["https://www.csdn.net/nav/db",
    ...
    def parse(self, response):
        ...
        # for sel in response.xpath('//main/ul/li'):
        ...
        #     item = DmozItem()
        #     # unicode编码为utf-8
        #     item['title'] = sel.xpath('div/div/h2/a/text()').extract()
        #     item['link'] = sel.xpath('div/div/h2/a/@href').extract()
